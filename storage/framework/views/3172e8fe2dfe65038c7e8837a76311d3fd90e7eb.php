...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="row">
        <div class="input-field col s12">
          <p class="margin medium-small"><a href="<?php echo e(route('login')); ?>">Already have an account? Login</a></p>
        </div>
      </div>
    </form>
  </div>
...
<?php echo $__env->make('layouts.fullLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/materialize-admin/materialize-html-laravel-template/resources/views//auth/register.blade.php ENDPATH**/ ?>