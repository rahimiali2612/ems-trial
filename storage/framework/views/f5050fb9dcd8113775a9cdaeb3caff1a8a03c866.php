  ...
  complete: function() { alert('Closed'); } // Callback for Modal close
    ...
    <div class="modal-content">
        ...
        <div class="input-field">
            <select class="select2 browser-default" id="availableRegularExpressionId" name="availableRegularExpressionId" placeholder="Search by Regular Expression">
            </select>
        </div>
        <div class="input-field">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/materialize-admin/materialize-html-laravel-template/resources/views/pages/advance-ui-modals.blade.php ENDPATH**/ ?>